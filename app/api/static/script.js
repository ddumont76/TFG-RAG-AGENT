async function sendQuery() {
    ...
    try {
        ...
        if (data.metrics) {
            updateMetricCard("faithfulness", data.metrics.faithfulness);
            updateMetricCard("answer_relevancy", data.metrics.answer_relevancy);
            updateMetricCard("context_precision", data.metrics.context_precision);
